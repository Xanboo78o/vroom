...
export function stepMachine(m, world, dt, onImpact){
  ...
  for(const w of m.wheels){
    ...
    const surf = world.gripAt ? world.gripAt(_wp.x, _wp.z) : 1;   // asphalt 1 · gravel · sand · grass
    const gripF = THREE.MathUtils.clamp(-slip * TUNE.grip * wingGrip * surf, -load * 3, load * 3);
